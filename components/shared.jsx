  ...
  return (
    <nav className="nav" aria-label="Principal">
      ...
      <div className="nav-right">
        <a href={waLink('default')} target="_blank" rel="noopener noreferrer" className="nav-cta hoverable">
    ...
    <footer className="footer">
      ...
      <div className="footer-grid container">
        ...
        <div className="footer-col">
          ...
          <a href={waLink('default')} target="_blank" rel="noopener noreferrer">Cotizar por WhatsApp</a>
        </div>
        <div className="footer-col">
          <h4>/ Contacto</h4>
          <a href="mailto:info@intothecom.com">info@intothecom.com</a>
          <a href={waLink('default')} target="_blank" rel="noopener noreferrer">WhatsApp +56 9 5016 0966</a>
